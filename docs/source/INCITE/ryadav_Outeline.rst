...
Simulations for the geodynamo by Rakesh Yadav (Harvard University). Simulations are thermally driven magnetohydrodynamics (MHD) simulations in a rotating spherical shell modeled on the Earth's outer core.
...
The thermally driven convection is assumed using the Boussinesq approximation. The inner core is assumed to be co-rotating with the mantle (outside of the spherical shell).
