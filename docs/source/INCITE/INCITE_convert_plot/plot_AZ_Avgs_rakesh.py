...
#  ax1 = f1.add_subplot(1,3,1)
  ...
  plot_azav(fig,ax[0],temperature,radius,costheta,sintheta,mycmap='hot',
            boundsfactor = 1.0, boundstype='minmax', units=units, fontsize = cbfsize)
...
#  ax1 = f1.add_subplot(1,3,2)
  units = '$u_\phi$'
  plot_azav(fig,ax[1],vphi,radius,costheta,sintheta,mycmap='seismic',
...
#  ax1 = f1.add_subplot(1,3,2)
  units = '$B_\phi$'
  plot_azav(fig,ax[2],bphi,radius,costheta,sintheta,mycmap='seismic',
            boundsfactor = 2.0, boundstype='rms', units=units, fontsize = cbfsize)
