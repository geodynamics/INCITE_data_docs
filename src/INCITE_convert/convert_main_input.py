...
def s_convert_main_input(org_file, new_file):
...
#  print(in_output)
  ...
  main_input.write(self=in_list, verbose = False, file=new_file, 
                   ndecimal=6, namelist=in_list)
  return
...
if __name__ == '__main__':
  ...
  ierr = s_convert_main_input(org_file, new_file)
